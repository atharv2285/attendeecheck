...
const AttendeeList = ({ checkedIn = [], awaiting = [] }) => {
  const renderAttendee = (attendee, index) => (
    <div key={index} className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-white/20 group">
      {/* Avatar */}
      ...
      <div className="session-card p-8 fade-in">
        ...
        {checkedIn.length > 0 ? (
          ...
          <div className="text-center py-12">
            <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-gray-500 to-gray-600 rounded-full flex items-center justify-center">
